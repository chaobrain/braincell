...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "rateconst_Kv", _hoc_rateconst,
 "rates_Kv", _hoc_rates,
 0, 0
};
#define rateconst rateconst_Kv
 extern double rateconst( _threadargsprotocomma_ double , double , double , double );
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Kv /home/swl/braincell/examples/convert_mod/mod_validate/mods/kv.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Simplified Kv example for BrainCell template generation";
...
double rateconst ( _threadargsprotocomma_ double _lv , double _lr , double _lth , double _lq ) {
   double _lrateconst;
 _lrateconst = _lr * ( _lv - _lth ) / ( 1.0 - exp ( - ( _lv - _lth ) / _lq ) ) ;
...
static void _hoc_rateconst(void) {
  ...
  _nt = nrn_threads;
 _r =  rateconst ( _p, _ppvar, _thread, _nt, *getarg(1) , *getarg(2) , *getarg(3) , *getarg(4) );
 hoc_retpushx(_r);
}
 
static int  rates ( _threadargsprotocomma_ double _lv ) {
   tadj = 1.0 ;
   ninf = 1.0 / ( 1.0 + exp ( - ( _lv - v12 ) / q ) ) ;
   ntau = 1.0 / ( tadj * ( rateconst ( _threadargscomma_ _lv , Ra , v12 , q ) + rateconst ( _threadargscomma_ _lv , - Rb , v12 , - q ) ) ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/swl/braincell/examples/convert_mod/mod_validate/mods/kv.mod";
static const char* nmodl_file_text = 
