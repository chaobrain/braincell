...
from braincell.legacy import morph as legacy_morph


class TestMorphologyConstruction:
    def test_single(self):
        # Instantiate a Morphology object
        morphology = legacy_morph.Morphology()
    ...
    def test_swc(self):
        ...
        morphology = legacy_morph.from_swc(swc_file)
        print(morphology)
        # Initialize DHS
        morphology.to_branch_tree()
    ...
    def test_asc(self):
        ...
        morphology = legacy_morph.from_asc(asc_file)
        print(morphology)
        # Initialize DHS
        morphology.to_branch_tree()
